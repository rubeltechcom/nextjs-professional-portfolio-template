...
import {RowForm, RowFormGroup, RowFormGroupAlert, RowFormGroupItem, RowFormGroupSubmit} from "@/components/forms/containers/RowForm.jsx"
import {MessageCard, MessageCardIcon, MessageCardBody, MessageCardFooter} from "@/components/generic/MessageCard.jsx"
import Input from "@/components/forms/fields/Input.jsx"
import Textarea from "@/components/forms/fields/Textarea.jsx"
...
function ArticleContactFormContent({ dataWrapper, selectedItemCategoryId, setShouldHideTitle }) {
    ...
    const _onApiResponse = (success) => {
        if(!success) {
            ...
            api.analytics.reportEvent("Contact", "Email Sent", "Contact Form")
