...
import Swipeable from "@/components/capabilities/Swipeable.jsx"
import AvatarView from "@/components/generic/AvatarView.jsx"
import DateBadge from "@/components/widgets/DateBadge.jsx"
import CircularButton from "@/components/buttons/CircularButton.jsx"
import Link from "@/components/generic/Link.jsx"
    ...
    return (
        <div className={`article-cards-item`}>
            ...
            <div className={`article-cards-item-content`}>
                <h3 className={`article-cards-item-content-title ${titleClass} h6`}
